...
api.userDefaults =
  habits: [
    {text: t('defaultHabit1Text'), notes: t('defaultTaskNotes'), value: 0, up: true, down: false, attribute: 'per'}
    {text: t('defaultHabit2Text'), notes: t('defaultTaskNotes'), value: 0, up: false, down: true, attribute: 'str'}
    {text: t('defaultHabit3Text'), notes: t('defaultTaskNotes'), value: 0, up: true, down: true, attribute: 'str'}
  ]
...
#    {text: t('defaultTodo5Text'), notes: t('defaultTodoNotes'), completed: false, attribute: 'per' }
  ...
  rewards: [
#   {text: t('defaultReward1Text'), notes: t('defaultTaskNotes'), value: 10 }
#   {text: t('defaultReward2Text'), notes: t('defaultTaskNotes'), value: 10 }
  ]
